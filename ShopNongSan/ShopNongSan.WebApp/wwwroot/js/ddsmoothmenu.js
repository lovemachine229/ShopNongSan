...
mobilemediaquery: "screen and (max-width: 1000px)", // CSS media query string that when matched activates mobile menu (while hiding default)
//Specify full URL to down and right arrow images (23 is padding-right for top level LIs with drop downs, 6 is for vertical top level items with fly outs):
arrowimages: {down:['downarrowclass', 'down.gif', 0], right:['rightarrowclass', 'images/icon-arr-right.svg', 0], left:['leftarrowclass', 'images/icon-arr-left.svg']},
transition: {overtime:400, outtime:200}, //duration of slide in/ out animation, in milliseconds
mobiletransition: 600, // duration of slide animation in mobile menu, in milliseconds
...
mobilezindexvalue: 99999, // mobile menus starting zIndex
...
buildmobilemenu: function($, setting, $ul){
	...
	if (!this.mobilecontainer.$main){ // if primary mobile menu container not defined yet
		...
		$maincontainer
			.css({zIndex: this.mobilezindexvalue++, right: '0%', visibility: 'hidden'})
